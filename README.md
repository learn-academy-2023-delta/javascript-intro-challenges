...
This repository holds the vanilla JavaScript pair programming challenges for the 2023 Delta cohort.
...
- Branch name: `topic-initials1-initials2` (ex. arrays-em-gm)
- File name: `topic-name1-name2.js` (ex. arrays-elyse-gene.js)
...
- $ `git checkout -b <topic-initials1-initials2>` (ex. arrays-em-gm)
